...
You must submit your code (see below)

### 3.1 Submit Process
To submit your code, please follow the guide below:
* Create a github repo for your project, name it as follows: `acmdb24-"student-id"`, where "student-id" refers to your student number. For example, my student number is 516030910594, so the project name will be `acmdb24-516030910594`. 
* Add `acmdb-lab0` as a directory to your github repo. 
* Add TAs github account to your repo.

TA: [Hao Duan](https://github.com/HDDHXH)
